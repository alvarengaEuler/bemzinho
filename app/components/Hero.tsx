  ...
  return (
    <div className="relative isolate">
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-20">
        <div className="border-2 border-red-500 max-w-2xl mx-auto lg:mx-0 lg:flex-auto">
          <div className="flex">
          ...
          <h1 className="mt-10 max-w-lg text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl">
        ...
        <div className="border-2 border-red-500 mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
          <svg
            viewBox="0 0 366 729"
            role="img"
